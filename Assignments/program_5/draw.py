...
class PygameHelper(object):
    ...
    def add_path(self,points):
        ...
        for p in points:
            coord = self.adjust_point(p)
            self.path.append(coord)
    
    def add_path_2(self,points):
    ...
    def start_display(self):
        ...
        while True:
            ...
            self.draw_polygons()
            if (self.path):
                pygame.draw.lines(self.screen, self.path_color, False, self.path, self.path_width)
            if (self.path2):
                pygame.draw.lines(self.screen, self.path_color, False, self.path2, self.path_width)
